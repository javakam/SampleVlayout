...
import sample.vlayout.ui.vlayout.adapter.holder.RecyclerItemViewHolder;
...
public class RecyclerBaseAdapter extends RecyclerView.Adapter {
    ...
    private List<VideoBean> itemDataList = null;
    ...
    public RecyclerBaseAdapter(Context context, List<VideoBean> itemDataList) {
    ...
    public void setListData(List<VideoBean> data) {
        itemDataList = data;
