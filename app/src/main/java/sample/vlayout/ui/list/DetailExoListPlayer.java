package sample.vlayout.ui.list;
...
import sample.vlayout.exo.GSYExo2PlayerView;
import sample.vlayout.exo.GSYExoVideoManager;
...
public class DetailExoListPlayer extends GSYBaseActivityDetail<GSYExo2PlayerView> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urls.add(new GSYVideoModel("http://player.alicdn.com/video/aliyunmedia.mp4", "标题666666"));
        urls.add(new GSYVideoModel("http://9890.vod.myqcloud.com/9890_4e292f9a3dd011e6b4078980237cc3d3.f20.mp4", "标题1"));
        urls.add(new GSYVideoModel("http://7xjmzj.com1.z0.glb.clouddn.com/20171026175005_JObCxCE2.mp4", "标题2"));
