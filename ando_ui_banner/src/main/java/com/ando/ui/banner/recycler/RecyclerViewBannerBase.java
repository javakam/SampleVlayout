package com.ando.ui.banner.recycler;
...
public abstract class RecyclerViewBannerBase<L extends RecyclerView.LayoutManager, A extends RecyclerView.Adapter> extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        mSelectedDrawable = getDrawableAttrRes(context, typedArray, R.styleable.RecyclerViewBannerBase_rvbb_indicatorSelectedSrc);
        mUnselectedDrawable = getDrawableAttrRes(context, typedArray, R.styleable.RecyclerViewBannerBase_rvbb_indicatorUnselectedSrc);
        int indicatorSize = typedArray.getDimensionPixelSize(R.styleable.RecyclerViewBannerBase_rvbb_indicatorSize, context.getResources().getDimensionPixelOffset(R.dimen.default_recycler_banner_indicatorSize));
        ...
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.RecyclerViewBannerBase_rvbb_indicatorSpace, context.getResources().getDimensionPixelOffset(R.dimen.default_recycler_banner_indicatorSpace));
        int marginLeft = typedArray.getDimensionPixelSize(R.styleable.RecyclerViewBannerBase_rvbb_indicatorMarginLeft, context.getResources().getDimensionPixelOffset(R.dimen.default_recycler_banner_indicatorMarginLeft));
        int marginRight = typedArray.getDimensionPixelSize(R.styleable.RecyclerViewBannerBase_rvbb_indicatorMarginRight, context.getResources().getDimensionPixelOffset(R.dimen.default_recycler_banner_indicatorMarginRight));
        int marginBottom = typedArray.getDimensionPixelSize(R.styleable.RecyclerViewBannerBase_rvbb_indicatorMarginBottom, context.getResources().getDimensionPixelOffset(R.dimen.default_recycler_banner_indicatorMarginBottom));
    ...
    private Drawable getDrawableAttrRes(Context context, TypedArray typedArray, @StyleableRes int index) {
