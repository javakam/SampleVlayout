...
import sample.vlayout.utils.ResUtils;
...
public class RippleView extends FrameLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, ResUtils.getColor(android.R.color.white));
