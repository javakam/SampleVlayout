...
import static sample.vlayout.exo.GSYExo2MediaPlayer.POSITION_DISCONTINUITY;
...
public class GSYExo2PlayerView extends StandardGSYVideoPlayer {
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            GSYExo2PlayerView exo2PlayerView = (GSYExo2PlayerView) gsyBaseVideoPlayer;
